  ...
  return (
    <>
     ...
     <div className='h-screen relative'>
        <Image src='/airplane_home.webp' layout='fill' alt='Loading Error' loading='lazy' className='opacity-100' objectFit='cover' />
      ...
      <footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="/" className="hover:underline">Skybeats™</a>. All Rights Reserved.</span>
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              {[
                ...
                { href: '#', svgPath: 'M20 0H0v20h20V0ZM8.25 15H5.5V8.25H8.25V15Zm-1.375-7.188A1.688 1.688 0 1 1 8.25 6.125a1.682 1.682 0 0 1-1.687 1.688Zm9.688 7.188h-2.75V11c0-.813-.688-1.5-1.5-1.5S11 10.188 11 11v4H8.25V8.25H11v.875c.438-.563 1.313-1.063 2.188-1.063 1.75 0 3.062 1.313 3.062 3.062V15Z', title: 'LinkedIn profile' }
              ].map((link, index) => (
                <a key={index} href={link.href} className="text-gray-500 hover:text-gray-900 dark:hover:text-white" title={link.title}>
