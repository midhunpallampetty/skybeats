  ...
  return (
    <div className="min-h-screen ">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto mt-20 bg-white/90 backdrop-blur-sm shadow-xl rounded-lg overflow-hidden" ref={ticketRef}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8">
            ...
            <DetailCard
              ...
              details={[
                'Total Passengers: 1',
                `Total Fare: ${selectedFlight.price * selectedSeat.length}`
              ]}
            />
          </div>
