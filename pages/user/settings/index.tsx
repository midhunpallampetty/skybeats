...
function Index() {
  ...
  useEffect(() => {
    ...
    if (savedAnimations !== null) setUseAnimations(savedAnimations === "true");
  ...
  }, [isDarkMode, useAnimations, fontSize, isMounted]);
    ...
    <>
      ...
      <div
        className={`min-h-screen transition-colors duration-300 ${
          isDarkMode ? "bg-[#0B1121] text-gray-200" : "bg-gray-100 text-gray-800"
        }`}
      >
        <div className="container mx-auto px-4 py-12 max-w-3xl mt-20">
          ...
          <div className={`p-8 rounded-2xl mb-8 transition-colors duration-300 ${isDarkMode ? "bg-[#151F32]" : "bg-white shadow-lg"}`}>
            ...
            <div className="mb-6">
              ...
              <div className={`border-2 border-dashed rounded-2xl p-10 text-center transition-colors duration-300 
              ...
              <div className="flex justify-between items-start mb-6">
                ...
                <button
                  ...
                  className={`p-3 rounded-xl transition-all duration-300 ${
                    isDarkMode ? "bg-blue-500 hover:bg-blue-600" : "bg-gray-200 hover:bg-gray-300"
                  }`}
                >
